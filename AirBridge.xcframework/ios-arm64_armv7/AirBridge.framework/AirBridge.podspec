Pod::Spec.new do |s|
    ...
    s.source                    = { 
        :http => "https://sdk-download.airbridge.io/frameworks/AirBridge.xcframework-1.22.0.zip"
    }
    s.preserve_paths            = "AirBridge_Files/AirBridge.xcframework"

    s.vendored_frameworks       = "AirBridge_Files/AirBridge.xcframework"
    s.ios.weak_frameworks       = "AdSupport", "iAd", "AdServices", "CoreTelephony", "StoreKit", "AppTrackingTransparency"
